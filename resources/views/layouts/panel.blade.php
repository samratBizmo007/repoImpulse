        ...
        <div class="main_container">
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="dashboard" class="site_title" style="padding-left: 15px">
                            <img src="{{URL::to('/')}}/template/images/impulse-logo-small.png" class="img img-responsive img-thumbnail w3-padding-top" style="width: 40px;height: auto"> Impulse
                        </a>
                    </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    Welcome <b>{{Session::get('sess_name')}} </b>
            ...
            <footer>
              <div class="pull-right">
                IMPULSE World Trends | Powered by <a href="https://bizmo-tech.com" target="_blank">Bizmo Technologies</a>
            </div>
            <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
...
<script src="{{ asset('assets/build/datatables.net/js/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('assets/build/datatables.net-bs/js/dataTables.bootstrap.min.js') }}"></script>
</html>

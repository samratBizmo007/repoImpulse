...
@section('content')
<title>Impulse Trends | <?php print_r($product_id); ?></title>
<!-- Page Title
    ============================================= -->
    <section id="page-title">

        <div class="container clearfix">
            <h1><?php print_r($product_id); ?></h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item"><a href="#">Products</a></li>
                <li class="breadcrumb-item active" aria-current="page"><?php print_r($product_id); ?></li>
            </ol>
        </div>
                            ...
                            <div class="card events-meta w3-col l12">
                                <div class="card-body">
                                    <ul class="portfolio-meta nobottommargin">
                                        <li><span style="width: 180px;"><i class="fa fa-download"></i>Download Brochures:</span> 
                                            <ul style="list-style: none;">
                                                <li style="padding-left: 20px"><a href="">Download file 1</a></li>
                                                <li style="padding-left: 20px"><a href="">Download file 2</a></li>
                                                <li style="padding-left: 20px"><a href="">Download file 3</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>

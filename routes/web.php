...
Route::get('/get-connect/unsubscribeEmail/{email}', 'ContactController@unsubscribeEmail');
...
Route::get('admin/send-mail/sendSubscriberMail', 'Admin\DashboardController@sendSubscriberMail')->middleware('usersession');
Route::post('admin/upload/uploadMailFile', 'Admin\DashboardController@uploadMailFile')->middleware('usersession');
...
Route::get('/delSubscriber/{sub_id}', 'Admin\DashboardController@delSubscriber')->middleware('usersession');
